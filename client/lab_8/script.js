...
async function mainEvent() {
  // the async keyword means we can make API requests *mainform
 ...
 const carto = initMap();
  ...
  console.log('type parsedData = ', typeof parsedData);
  console.log('type storedData = ', typeof storedData);
  ...
  generateListButton.addEventListener("click", (event) => {
    ...
    console.log('what is storedData: ', typeof storedData)
